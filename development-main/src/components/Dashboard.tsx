  ...
  const additionalKPIs = useMemo(() => {
    ...
    filteredData.forEach(order => {
      ...
      partnerData.set(order.shippingPartner, {
        ...
        rtoCount: current.rtoCount + (['rto', 'rto_delivered', 'rto_initiated', 'rto_undelivered'].some(status => 
    ...
    return {
      ...
      bestPartnerRTO: { name: bestPartner.name, value: bestPartner.rtoRate, successRate: bestPartner.successRate }
    };
  }, [filteredData]);
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-green-400">
            <div className="flex justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-gray-800">{fixedStats?.rtoRate.toFixed(1)}%</p>
              </div>
              <div className="bg-green-50 p-2 rounded-md self-start">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-green-500">
                  <path fillRule="evenodd" d="M8.603 3.799A4.49 4.49 0 0112 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 013.498 1.307 4.491 4.491 0 011.307 3.497A4.49 4.49 0 0121.75 12a4.49 4.49 0 01-1.549 3.397 4.491 4.491 0 01-1.307 3.497 4.491 4.491 0 01-3.497 1.307A4.49 4.49 0 0112 21.75a4.49 4.49 0 01-3.397-1.549 4.49 4.49 0 01-3.498-1.306 4.491 4.491 0 01-1.307-3.498A4.49 4.49 0 012.25 12c0-1.357.6-2.573 1.549-3.397a4.49 4.49 0 011.307-3.497 4.49 4.49 0 013.497-1.307zm7.007 6.387a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" clipRule="evenodd" />
            ...
            <p className="text-xs text-gray-500 mt-2">
              RTO Cost (%): {(fixedStats?.rtoRate.toFixed(1) * 2)}%
            </p>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-red-400">
            <div className="flex justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-gray-800">{additionalKPIs.bestPartnerRTO.value.toFixed(1)}%</p>
              </div>
              <div className="bg-red-50 p-2 rounded-md self-start">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-red-500">
                  <path fillRule="evenodd" d="M8.603 3.799A4.49 4.49 0 0112 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 013.498 1.307 4.491 4.491 0 011.307 3.497A4.49 4.49 0 0121.75 12a4.49 4.49 0 01-1.549 3.397 4.491 4.491 0 01-1.307 3.497 4.491 4.491 0 01-3.497 1.307A4.49 4.49 0 0112 21.75a4.49 4.49 0 01-3.397-1.549 4.49 4.49 0 01-3.498-1.306 4.491 4.491 0 01-1.307-3.498A4.49 4.49 0 012.25 12c0-1.357.6-2.573 1.549-3.397a4.49 4.49 0 011.307-3.497 4.49 4.49 0 013.497-1.307zm7.007 6.387a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" clipRule="evenodd" />
            ...
            <p className="text-xs text-gray-500 mt-2">
              Partner: {additionalKPIs.bestPartnerRTO.name} | Success Rate: {additionalKPIs.bestPartnerRTO.successRate.toFixed(1)}%
            </p>
          </div>
              ...
              <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-semibold text-blue-600">
                    {(100 - ((fixedStats?.successRate || 0) + (fixedStats?.rtoRate || 0)))}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2.5">
                  <div 
